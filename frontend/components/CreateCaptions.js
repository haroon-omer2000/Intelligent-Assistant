        ...
        <View style = {styles.container}>
            <View style = {styles.languageDrpDwn}>
                <View style={styles.header}>
                    <Text style={styles.text}>Select Language for Captions:</Text>
                </View>
                <DropDownPicker
                    open={open}
            ...
            <View style = {styles.container}>
                ...
                { (image && uploadedImage ) ? 
                    (<Text style = {styles.uploadIcon} onPress = {uploadImage} >Generate Captions</Text>)
                    : null
                }
                {captions ?
                    (
                        <View>
                            <Text style = {styles.uploadIcon}>Generated Caption</Text>
                            <Text style = {styles.uploadStatus} >{captions}</Text>
                        </View>
                    )
                    :null
                }
